...
Enables fans to discuss live/recent matches in context.
"""
...
4. react_to_discussion — React with emoji (🔥 💯 😢 🎉 👏)
...
- Help fans articulate their thoughts if they're vague (e.g., "that was amazing" → help them create a thread about the specific moment)
